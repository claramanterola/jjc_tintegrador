        ...
        <div class="row">
          <div class="col-12 col-md-6 col-lg-4 text-center my-4">
            <div class="card" style="width: 18rem;">
                <img src="img/controlsale.jpg" class="card-img-top" alt="Raquetas">
            <div class="card-body">
              <h5 class="card-title">RAQUETAS</h5>
              <p class="card-text">Aprovecha</p>
          ...
          <div class="col-12 col-md-6 col-lg-4 text-center my-4">
            <div class="card" style="width: 18rem;">
<img src="img/tuboheadsale.jpg" class="card-img-top" alt="Pelotas">
<div class="card-body">
  ...
  <a href="pelotas.html" class="btn btn-primary">Ver Más</a>
          ...
          <div class="col-12 col-md-6 col-lg-4 text-center my-4">
            <div class="card" style="width: 18rem;">
<img src="img/cuerdasale.jpg"class="card-img-top" alt="Cuerdas">
<div class="card-body">
